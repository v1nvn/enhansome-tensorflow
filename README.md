...
* [TensorFlow Examples](https://github.com/aymericdamien/TensorFlow-Examples) ⭐ 43,805 | 🐛 227 | 🌐 Jupyter Notebook | 📅 2024-07-26 - TensorFlow tutorials and code examples for beginners
...
* [Classification on time series](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition) ⭐ 3,556 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2022-11-06 - Recurrent Neural Network classification in TensorFlow with LSTM on cellphone sensor data
...
* [MusicGenreClassification](https://github.com/mlachmish/MusicGenreClassification) ⭐ 597 | 🐛 10 | 🌐 Python | 📅 2020-01-11 - Classify music genre from a 10 second sound stream using a Neural Network.
...
* [android-yolo](https://github.com/natanielruiz/android-yolo) ⭐ 689 | 🐛 13 | 🌐 C++ | 📅 2022-10-15 - Real-time object detection on Android using the YOLO network, powered by TensorFlow.

<a name="libraries" />

## Libraries

* [TensorFlow-Slim](https://github.com/tensorflow/models/tree/master/inception/inception/slim) ⭐ 77,687 | 🐛 1,276 | 🌐 Python | 📅 2026-02-13 - High-level library for defining models
* [SyntaxNet: Neural Models of Syntax](https://github.com/tensorflow/models/tree/master/syntaxnet) ⭐ 77,687 | 🐛 1,276 | 🌐 Python | 📅 2026-02-13 - A TensorFlow implementation of the models described in [Globally Normalized Transition-Based Neural Networks, Andor et al. (2016)](http://arxiv.org/pdf/1603.06042.pdf)
* [Sonnet](https://github.com/deepmind/sonnet) ⭐ 9,902 | 🐛 39 | 🌐 Python | 📅 2026-02-10 - Sonnet is DeepMind's library built on top of TensorFlow for building complex neural networks.
* [tflearn](https://github.com/tflearn/tflearn) ⭐ 9,606 | 🐛 579 | 🌐 Python | 📅 2024-05-06 - Deep learning library featuring a higher-level API
...
* [Speedster](https://github.com/nebuly-ai/nebullvm/tree/main/apps/accelerate/speedster) ⭐ 8,354 | 🐛 111 | 🌐 Python | 📅 2024-07-22 - Automatically apply SOTA optimization techniques to achieve the maximum inference speed-up on your hardware.
...
* [Globally Normalized Transition-Based Neural Networks](http://arxiv.org/abs/1603.06042) - This paper describes the models behind [SyntaxNet](https://github.com/tensorflow/models/tree/master/syntaxnet) ⭐ 77,687 | 🐛 1,276 | 🌐 Python | 📅 2026-02-13.
...
* [Probabilistic Programming and Bayesian Methods for Hackers](https://github.com/CamDavidsonPilon/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers) ⭐ 28,482 | 🐛 204 | 🌐 Jupyter Notebook | 📅 2024-06-25 - by Cameron Davidson-Pilon. Introduction to Bayesian methods and probabilistic graphical models using tensorflow-probability (and, alternatively PyMC2/3).
...
* Some of the python libraries were cut-and-pasted from [vinta](https://github.com/vinta/awesome-python) ⭐ 283,698 | 🐛 17 | 🌐 Python | 📅 2026-02-19
