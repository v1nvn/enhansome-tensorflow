...
* [TensorFlow Tutorial 2](https://github.com/nlintz/TensorFlow-Tutorials) ⭐ 6,030 | 🐛 16 | 🌐 Jupyter Notebook | 📅 2023-08-20 - Introduction to deep learning based on Google's TensorFlow framework. These tutorials are direct ports of Newmu's Theano
...
* [Kubeflow](https://github.com/kubeflow/kubeflow) ⭐ 15,657 | 🐛 3 | 📅 2026-05-24 - Framework for easily using Tensorflow with Kubernetes.
...
* [SRGAN](https://github.com/tensorlayer/srgan) ⭐ 3,478 | 🐛 153 | 🌐 Python | 📅 2024-02-22 - Photo-Realistic Single Image Super-Resolution Using a Generative Adversarial Network
...
* [TensorFlowOnSpark](https://github.com/yahoo/TensorFlowOnSpark) ⭐ 3,853 | 🐛 16 | 🌐 Python | 📅 2023-07-10 - initiative from Yahoo! to enable distributed TensorFlow with Apache Spark.
...
* [Speedster](https://github.com/nebuly-ai/nebullvm/tree/main/apps/accelerate/speedster) ⭐ 8,341 | 🐛 110 | 🌐 Python | 📅 2024-07-22 - Automatically apply SOTA optimization techniques to achieve the maximum inference speed-up on your hardware.
...
* Some of the python libraries were cut-and-pasted from [vinta](https://github.com/vinta/awesome-python) ⭐ 299,457 | 🐛 22 | 🌐 Python | 📅 2026-05-24
