...
* [Kubeflow](https://github.com/kubeflow/kubeflow) ⭐ 15,445 | 🐛 0 | 📅 2026-01-05 - Framework for easily using Tensorflow with Kubernetes.
...
* [Chatbot](https://github.com/Conchylicultor/DeepQA) ⭐ 2,927 | 🐛 93 | 🌐 Python | 📅 2022-12-30 - Implementation of ["A neural conversational model"](http://arxiv.org/abs/1506.05869)
...
* [MusicGenreClassification](https://github.com/mlachmish/MusicGenreClassification) ⭐ 595 | 🐛 10 | 🌐 Python | 📅 2020-01-11 - Classify music genre from a 10 second sound stream using a Neural Network.
...
* [YOLO TensorFlow](https://github.com/gliese581gg/YOLO_tensorflow) ⭐ 1,717 | 🐛 38 | 🌐 Python | 📅 2019-01-05 - Implementation of 'YOLO : Real-Time Object Detection'
...
* [TensorFlow-Slim](https://github.com/tensorflow/models/tree/master/inception/inception/slim) ⭐ 77,695 | 🐛 1,274 | 🌐 Python | 📅 2026-02-10 - High-level library for defining models
* [SyntaxNet: Neural Models of Syntax](https://github.com/tensorflow/models/tree/master/syntaxnet) ⭐ 77,695 | 🐛 1,274 | 🌐 Python | 📅 2026-02-10 - A TensorFlow implementation of the models described in [Globally Normalized Transition-Based Neural Networks, Andor et al. (2016)](http://arxiv.org/pdf/1603.06042.pdf)
* [Sonnet](https://github.com/deepmind/sonnet) ⭐ 9,903 | 🐛 39 | 🌐 Python | 📅 2026-02-10 - Sonnet is DeepMind's library built on top of TensorFlow for building complex neural networks.
...
* [TensorFrames](https://github.com/tjhunter/tensorframes) ⭐ 745 | 🐛 54 | 🌐 Scala | 📅 2024-07-30 - TensorFlow binding for Apache Spark
...
* [Speedster](https://github.com/nebuly-ai/nebullvm/tree/main/apps/accelerate/speedster) ⭐ 8,356 | 🐛 111 | 🌐 Python | 📅 2024-07-22 - Automatically apply SOTA optimization techniques to achieve the maximum inference speed-up on your hardware.
...
* [Globally Normalized Transition-Based Neural Networks](http://arxiv.org/abs/1603.06042) - This paper describes the models behind [SyntaxNet](https://github.com/tensorflow/models/tree/master/syntaxnet) ⭐ 77,695 | 🐛 1,274 | 🌐 Python | 📅 2026-02-10.
...
More info on the [guidelines](https://github.com/jtoy/awesome-tensorflow/blob/master/contributing.md) ⭐ 17,758 | 🐛 30 | 📅 2026-02-08
