...
* [Kubeflow](https://github.com/kubeflow/kubeflow) ⭐ 15,517 | 🐛 1 | 📅 2026-01-05 - Framework for easily using Tensorflow with Kubernetes.
...
* [Chatbot](https://github.com/Conchylicultor/DeepQA) ⭐ 2,923 | 🐛 93 | 🌐 Python | 📅 2022-12-30 - Implementation of ["A neural conversational model"](http://arxiv.org/abs/1506.05869)
...
* [Probabilistic Programming and Bayesian Methods for Hackers](https://github.com/CamDavidsonPilon/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers) ⭐ 28,435 | 🐛 204 | 🌐 Jupyter Notebook | 📅 2024-06-25 - by Cameron Davidson-Pilon. Introduction to Bayesian methods and probabilistic graphical models using tensorflow-probability (and, alternatively PyMC2/3).
